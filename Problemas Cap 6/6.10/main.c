...
void Cuadrado(int A[][MAX], int N)/* Esta funcion se utiliza para formar el cuadrado magico. */
{
...
void Imprime(int A[][MAX], int N) /* Esta funcion se utiliza para escribir el cuadrado magico. */
{
    int I, J;
    for (I = 0; I < N; I++)
        for (J = 0; J < N; J++)
