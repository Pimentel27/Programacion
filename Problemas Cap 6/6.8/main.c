...
void Traspuesta(int M1[][MAX], int M2[][MAX], int F, int C) /* Esta funcion se utiliza para calcular la traspuesta. */
{
    int I, J;
    for (I=0; I<F; I++)
        for (J=0; J<C; J++)
...
void Imprime(int A[][MAX], int F, int C)/* Esta funcion se utiliza para escribir una matriz de tipo entero de F filas y C columnas
