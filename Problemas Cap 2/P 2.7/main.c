...
/* Ventas descendentes.
El programa, al recibir como datos tres valores que representan las ventas de los vendedores
de una tienda de disco, escribe las ventas en orden descendente.

P, D y R: variable de tipo real.         */
