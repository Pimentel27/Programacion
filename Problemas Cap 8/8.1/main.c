...
/* Estructuras 1.
El programa muestra la manera en que se declara una estructura, asi como la forma en que se tiene acceso a los campos de las
...
struct alumno /*Declaracion de la estructura */
{
    int matricula;
    char nombre[20];
    char carrera[20];/* Campos de estructura */
    float promedio;
    char direccion[20];
    /*Observa que la declaracion de una estructura termina en punto y coma. */
};

void main(void) /* Observa que las variables de tipo estructura se declaran como cualquier otra variable. a1, a2 y a3 son variables
 de tipo estructura alumno. */


{
    struct alumno a1 = {120, "María", "Contabilidad", 8.9, "Querétaro"}, a2, a3;/* Los campos de a1 reciben valores directamente. */
...
/* Observe la forma en que se imprimen los campos de s1 y a2. */
